...
<div class="mx-auto">
	...
	<footer class="bg-blue-900 h-40 flex items-center justify-center text-sm font-medium text-gray-300 px-4 sm:px-6 lg:px-8">
		<div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row">
			<div class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-0 md:border-gray-700	flex flex-wrap items-center text-grey justify-center">
			...
			<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
					...
					<ul>
						<li class="mb-4">
							<a href="#" target="_blank"
								class="text-gray-400 hover:underline dark:text-gray-400">Slim Styles</a>
						</li>
				...
				<div>
					...
					<ul>
						<li>
							<a href="#" target="_blank" class="text-gray-400 hover:underline dark:text-gray-400">Terms
								&amp; Conditions</a>
          </li>    
					</ul>
				</div>
